const data = {
  basics: {
    name: "Sumit Rathod",
    summary: `Full Stack And Software developer focused on building scalable, real-time systems and modern web applications. Experienced in API-driven architectures, cloud deployments, and event-based systems using technologies like Node.js, React, WebSockets, MQTT, Docker, and GCP. Passionate about solving real-world problems through clean engineering, reliable backend infrastructure, and high-performance user experiences.
`,
    location: {
      city: "Mumbai",
      country: "India",
...
const locationText = [basics?.location?.city, basics?.location?.country]
  .filter(Boolean)
  .join(", ");
const summary =
