const projects = [
  {
    ...
    preview: "/thumbnail/MarkForge-landing.png",
    previews: ["/thumbnail/Markforge-1.png", "/thumbnail/Markforge-2.png"],
    techStack: [
    ...
    details: [
      "Built a modular Node.js–Python document processing pipeline.",
      "Integrated Microsoft MarkItDown for PDF → Markdown conversion.",
      "Preserved document structure including headings, tables, lists, and code blocks.",
      "Implemented Node.js ↔ Python communication using child processes and JSON.",
      "Added AI-based document classification across multiple document types.",
      "Developed specialized AI prompt routing for context-aware processing.",
      "Built a service-oriented Express.js + TypeScript backend architecture.",
      "Added Zod validation, centralized error handling, and standardized API responses.",
      "Refactored Python processing into modular extraction services.",
      "Implemented temporary file cleanup for improved privacy and storage efficiency.",
      "Prepared asset extraction support for images, diagrams, and charts using PyMuPDF.",
    ],
    "Github-Link": "https://github.com/Sumitr995/MarkForge",
    "Live-Link": "https://markforge.sumitr995.me",
  },
  {
  ...
  },
  {
    ...
    techStack: [
      ...
      {
        name: "Bcrypt",
        icon: "https://cdn.jsdelivr.net/npm/lucide-static@latest/icons/hash.svg",
      },
