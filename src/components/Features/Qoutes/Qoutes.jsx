...
import { pickRandomFallbackQuote } from '@/Utils/Qoutes';

const Qoutes = () => {
  const [currentQuote, setCurrentQuote] = useState(() => pickRandomFallbackQuote());

  useEffect(() => {
    const interval = setInterval(() => {
      setCurrentQuote(pickRandomFallbackQuote());
    }, 10000);
